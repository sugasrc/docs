...
<AccordionGroup>
  ...
  <Accordion title="Volume Full">
    ...
    **Solutions:**
    ...
    - Volume size limits vary by plan—check your dashboard for current limits
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Want to Downgrade">
    **Symptoms:** Want to switch from Pro to Hobby

    **Solutions:**
    - First reduce resources to fit Hobby limits:
      - Max 1 project
      - Max 3 environments
