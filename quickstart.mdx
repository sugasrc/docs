...
Click the **Add** button to open the **Add Resource** palette, then select **Function**. A new Deno function appears on the canvas with a default Hello World handler.
