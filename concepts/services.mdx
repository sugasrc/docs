...
Enter credentials in the **Add Container** dialog (or **Edit Container** for an existing service), under **Registry credentials**. See [Private Registries](/reference/private-registries) for setup.
