...
<Steps>
  ...
  <Step title="Wire the app's environment variables">
    ...
    Last, add `DEBUG` set to `False`. A fresh `settings.py` defaults to `True`, which serves tracebacks and settings to anyone who hits the public URL.
