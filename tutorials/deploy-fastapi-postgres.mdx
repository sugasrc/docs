...
<Steps>
  <Step title="Create a project from your repo">
    In the Suga dashboard, click **New Project** and pick your FastAPI repo from the GitHub list, installing the Suga GitHub App if prompted (see [Build from GitHub](/concepts/services#build-from-github)). Configure the import, leaving the build method on auto-detect, and create the project. Suga opens the canvas with the app service already connected to your repo.
  </Step>
