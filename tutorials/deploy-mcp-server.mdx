...
<Steps>
  ...
  <Step title="Add the server container from your repo">
    Right-click empty space on the canvas and choose **Add Container**. In the **Image** section, follow [Build from GitHub](/concepts/services#build-from-github) to install the Suga GitHub App (once per account or org), pick your MCP server repo and branch, and leave the build method on auto-detect. In the **Private Network** section, set the port to whatever your server listens on (typically `3000` or `8000`).
  </Step>
