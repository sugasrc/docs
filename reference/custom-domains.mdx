...
<AccordionGroup>
  ...
  <Accordion title="Why can't I use an apex domain with my DNS provider?">
    Standard DNS does not allow CNAME records at the zone apex. Your provider needs to support CNAME flattening, ANAME, or ALIAS records. If it doesn't, use a subdomain like `www.example.com` instead.
  </Accordion>
</AccordionGroup>
