...
| Scaling | Manual horizontal up to 100 instances; autoscaling on Pro workspace plan and higher | Manual horizontal up to 10 replicas on Pro |
...
| Autoscaling | Pro workspace plan and above | Not offered; replicas are set manually |
| Scaling ceiling | Up to 100 instances | Up to 10 replicas on Pro |
