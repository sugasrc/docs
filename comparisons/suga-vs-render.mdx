...
|---|---|---|
| Runtimes | Native runtimes for Node.js/Bun, Python, Ruby, Go, Rust, and Elixir; any via Dockerfile | Any via Dockerfile or auto-detected source builds; Deno for Functions |
...
| Container support | Dockerfile, native runtimes, and pre-built images from Docker Hub, GHCR, GitLab CR, Google Artifact Registry, and ECR | Dockerfile, auto-detected source builds, and pre-built images from any registry |
...
| Image optimization | Not currently exposed | Not currently exposed to customers |
...
| TLS | Automatic (Let's Encrypt and Google Trust Services) | Let's Encrypt and Cloudflare Origin CA with mTLS to origin |
